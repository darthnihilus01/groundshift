        ...
        def apply_cloud_mask(
            ...
            result.reference_masked_path = reference_masked_path
            result.target_masked_path = target_masked_path
            result.reference_cloud_mask_path = reference_cloud_mask_path
            result.target_cloud_mask_path = target_cloud_mask_path
            return result
